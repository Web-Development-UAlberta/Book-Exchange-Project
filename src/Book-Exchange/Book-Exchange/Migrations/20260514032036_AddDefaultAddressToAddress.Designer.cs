...
namespace Book_Exchange.Migrations
{
    ...
    [Migration("20260514032036_AddDefaultAddressToAddress")]
    partial class AddDefaultAddressToAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "book_condition", new[] { "acceptable", "good", "like_new", "poor", "very_good" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "exchange_status", new[] { "accepted", "cancelled", "completed", "rejected", "requested" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "notification_category", new[] { "exchange_accepted", "exchange_rejected", "exchange_requested", "match_found", "new_message", "transaction_update", "wishlist_available" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "shipment_status", new[] { "cancelled", "delivered", "label_created", "pending", "quoted", "shipped" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "transaction_status", new[] { "cancelled", "completed", "confirmed", "disputed", "shipped" });
            ...
            modelBuilder.Entity("Book_Exchange.Models.BookCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Book_Exchange.Models.ExchangeRequest", b =>
                {
                    ...
                    b.Property<ExchangeStatus>("Status")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Book_Exchange.Models.Listing", b =>
                {
                    ...
                    b.Property<BookCondition>("Condition")
            ...
            modelBuilder.Entity("Book_Exchange.Models.Notification", b =>
                {
                    ...
                    b.Property<NotificationCategory>("Category")
